...
export const themeConfig: ThemeConfig = {
  ...
  global: {
    ...
    moreLocales: ['en', 'es', 'ja', 'ru', 'zh', 'zh-tw'], // ['de', 'en', 'es', 'fr', 'ja', 'ko', 'pl', 'pt', 'ru', 'zh', 'zh-tw']
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/christophergyman',
      },
      {
        name: 'Email',
        url: 'email@christophergayiuman@gmail.com',
      },
      // {
      //   name: 'X',
